...
const ConfirmPasswordSchema = Yup.object().shape({
  current_password: Yup.string().required('Curent password is required'),
...
const ChangePassScreen = () => {
  ...
  const { changePassword, loading, error, clearError } = useAuthApi();
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      // Call API
      const result = await changePassword(resetData);
